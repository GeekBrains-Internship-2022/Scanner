...
namespace Scanner.Views.Windows
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //private static async Task ObserverTest()
        //{
        //    var observer = App.Services.GetRequiredService<ObserverService>();
        //    var path = __Configuration["ObserverPath"];
        //    observer.NotifyOnCreated += OnCreatedNotify;

        //    await observer.StartAsync();
        //}

        //private static void OnCreatedNotify(string message) => Debug.WriteLine(message);
